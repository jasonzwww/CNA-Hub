...
export const TRANSLATIONS = {
  en: {
    ...
    stewardDesc: "Expert advice on pit strategy, fuel saving, and league rules.",
    askAnything: "Ask the steward anything...",
    resume: "RESUME",
    manualMode: "Manual Mode",
    stewardGreeting: "Greetings, Driver. I am the CNA Racing AI Steward. How can I assist you with your race strategy or league inquiries today?",
    gt3Open: "GT3 Open",
    rookies: "Rookies",
    rank: "Rank",
    points: "Points",
  ...
  zh: {
    ...
    activeNow: "招募中",
    sendMessage: "申请加入战队",
    stewardDesc: "关于进站策略、节油和联赛规则的专家建议。",
    askAnything: "向干事提问...",
    resume: "恢复自动旋转",
    manualMode: "手动模式",
    stewardGreeting: "你好，车手。我是 CNA Racing AI 赛事干事。今天我能在比赛策略或联赛咨询方面为你提供什么帮助吗？",
    gt3Open: "GT3 公开赛",
    rookies: "新人赛",
    rank: "排名",
    points: "积分",
